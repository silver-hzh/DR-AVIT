...
class TrainOptions():
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--dataroot', type=str, default='F:\DRIT-master\datasets\summer2winter_yosemite',
                                 help='path of data')
        ...
        self.parser.add_argument('--img_save_freq', type=int, default=100, help='freq (it) of saving images')
        ...
        # training related
        self.parser.add_argument('--no_ms', default='True', action='store_true',
                                 help='disable mode seeking regularization')
        ...
        self.parser.add_argument('--direction', type=int, default=0, help='transformation gc rot direction')
        self.parser.add_argument('--geometry', type=str, default='gc', help='transformation gc')

        self.parser.add_argument('--lambda_gc', type=int, default=20, help='the hyperparamter of dual '
                                                                           'geometry-consistency loss')  # 400 * d_iter
        self.parser.add_argument('--n_ep', type=int, default=100, help='number of epochs')  # 400 * d_iter

        self.parser.add_argument('--n_ep_decay', type=int, default=50,
...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--direction', type=int, default=0, help='transformation gc rot direction')
        self.parser.add_argument('--geometry', type=str, default='gc', help='transformation gc')
        self.parser.add_argument('--lambda_gc', type=int, default=20,
                                 help='the hyperparamter of dual geometry-consistency loss')
